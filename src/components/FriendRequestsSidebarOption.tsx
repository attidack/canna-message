...
const FriendRequestsSidebarOption: FC<FriendRequestsSidebarOptionProps> = ({
  ...
  return <Link href='/dashboard/requests' className='text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'>
    <div className='text-grayt-200 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white'>
    ...
    {unseenRequestCount > 0 ?(
        <div className='rounded-full w-5 h-5 text-xs grid place-items-center text-white bg-indigo-600'>
            {unseenRequestCount}
        </div>
    ) : null }
  </Link>
